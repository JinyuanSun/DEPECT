...
$command = "python3 depect_ca_server.py -s ".$seqfilename." -db  database/all_nr_thermo.fasta -e ".$e." -ic ".$ic." -nt 1 -sc ".$score." -m blast";
echo exec($command);
sleep(10);
function downtemplateAction($file_name){
    ...
    {
        echo "计算还未完成，请稍后访问 www.lab.cf/depect/".$fil_ename." 下载！";
        exit;
    }
